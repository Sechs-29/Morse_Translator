...
function conversion() {
    ...
    */
    if (dictionary == englishDictionary) var inputArray = new String(document.getElementById('input-morse').value).toLowerCase().split('');
    else var inputArray = new String(transJapanese(document.getElementById('input-morse').value)).split('');
