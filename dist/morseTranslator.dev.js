...
function conversion() {
  ...
  */
  ...
  if (dictionary == englishDictionary) inputArray = new String(document.getElementById("input-morse").value).toLowerCase().split('');else inputArray = new String(transJapanese(document.getElementById("input-morse").value)).split('');
  /*
